...
<section class='relative py-20 bg-black md:py-30'>
    ...
    <a href="" class="w-full md:w-1/2 p-10">
        <div class="card w-full bg-black/30 border border-white border-opacity-30 rounded-2xl text-center p-5">
            <div class="image-container w-full relative overflow-hidden mt-[-80px]">
                <img src="/images/speakers/updated/Dr. Manaloto.png" alt="Dr. Manaloto.png" class="mx-auto w-[350px]">
            </div>
        </div>
    </a>
    ...
    <div class="w-full md:w-1/2 text-left text-white">
        <h1 class="text-xl md:text-4xl font-bold">DR. ADRIAN CARLOS MANALOTO</h1>
        <div class='mt-2 text-sm'>
            ...
            <p class='mt-5 text-xl'>"Chairside FPD Temporization techniques"</p>
                <div class='text-justify'>
                    <p class='mt-5'>Dental Practice in the Philippines is in full gear these days. The demand for prosthetic rehabilitation of our patients is now possible. Knowing how to do chairside temporization may optimize our practice, so we can render quicker responses to the fast trends of patient treatment today.
                    </p>
                </div>
            </div>
    </div>
