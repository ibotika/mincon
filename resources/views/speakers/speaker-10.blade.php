    ...
    <div class='mx-auto md:px-8 md:max-w-6xl'>
        <div class='relative z-10 m-10'>
            ...
            <div class='text-justify text-white text-sm'>
                ...
                <p class='mb-5'>With a career highlighted with accolades such as 1st Place in both the Thesis Competition and ISAAS Thesis Presentation, and extensive training in digital aesthetics </p>
                <p class='mb-5'>and implantology from across the globe, Doc Vin embodies the blend of academic excellence and practical expertise. His commitment to advancing dental practice through technology and his role as an Information Officer with the Philippine Eagles show his passion for both innovation and community.</p>
